...
object ApiEndPoint {
    ...
    val ENDPOINT_SERVER_USERS = BuildConfig.BASE_URL + "family"
    val ENDPOINT_SERVER_GET_IMAGE = BuildConfig.SITE_URL + "storage/users/"

    val NOMINATIM = "https://nominatim.openstreetmap.org/reverse.php"
}