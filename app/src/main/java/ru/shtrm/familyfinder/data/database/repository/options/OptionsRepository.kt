package ru.shtrm.familyfinder.data.database.repository.options
...
class OptionsRepository @Inject constructor(private val optionsDao: OptionsDao) : OptionsRepo {
    ...
    override fun loadOptions(questionId: Long): Single<List<Options>> = Single.fromCallable({ optionsDao.loadOptionsByQuestionId(questionId) })
